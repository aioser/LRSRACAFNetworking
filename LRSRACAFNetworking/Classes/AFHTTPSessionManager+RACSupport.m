...
- (RACSignal *)rac_requestPath:(NSString *)path parameters:(id)parameters method:(NSString *)method requestBuilder:(void(^)(NSMutableURLRequest *request))requestBuilder {
	return [RACSignal createSignal:^(id<RACSubscriber> subscriber) {
...
- (RACSignal *)rac_requestPath:(NSString *)path parameters:(id)parameters method:(NSString *)method {
	return [self rac_requestPath:path parameters:parameters method:method requestBuilder:nil];
}
